...
var Pagination = function (el, options) {
	...
	getRenderedPageNumbers = function () {
		...
		result = '<li class="page-item" data-page="' + FIRST_PAGE_NUMBER + '"><a class="page-link" href="javascript:void(0)"><span aria-hidden="true">' + firstPageLabel + '</span></a></li>' +
				 '<li class="page-item" data-page="' + PREVIOUS_PAGE_NUMBER + '"><a class="page-link" href="javascript:void(0)"><span aria-hidden="true">' + previousPageLabel + '</span></a></li>';

		$.each(pageNumbers, function (i, p) {
			result += '<li data-page="' + p + '" ' + (p === currentPage ? 'class="page-item active"' : '') + '><a class="page-link" href="javascript:void(0)">' + p + '</a></li>';
		});

		result += '<li class="page-item" data-page="' + NEXT_PAGE_NUMBER + '"><a class="page-link" href="javascript:void(0)"><span aria-hidden="true">' + nextPageLabel + '</span></a></li>' +
				  '<li class="page-item" data-page="' + LAST_PAGE_NUMBER + '"><a class="page-link" href="javascript:void(0)"><span aria-hidden="true">' + lastPageLabel + '</span></a></li>';
