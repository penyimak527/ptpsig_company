...
<?php $structure = !empty($struktur_organisasi) ? $struktur_organisasi : NULL; ?>
...
<section class="pyramid-structure-page">
	<div class="container">
		...
		<?php if ($structure !== NULL) : ?>
			<div class="pyramid-structure-chart"><img src="<?php echo strpos($structure['foto'], 'upload/') === 0 ? $base_path . '/' . $structure['foto'] : $asset_path . '/' . $structure['foto']; ?>" alt="Bagan Struktur Organisasi Piramidsoft"></div>
		<?php else : ?>
