		...
		<div class="row align-items-center">
			<div class="col-lg-6">
				<div class="infetech-about-thumb animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="0ms">
					<img src="<?php echo $asset_path; ?>/images/company-thumb.png" alt="Legalitas Piramidsoft">
					<img class="thumb" src="<?php echo $asset_path; ?>/images/company-thumb-2.png" alt="Legalitas Piramidsoft">
				</div>
			</div>
			<div class="col-lg-6">
				<div class="infetech-about-content">
					<span>Legalitas Perusahaan</span>
					<h3 class="title">PT Pyramidsoft Indonesia Group</h3>
					...
					<ul>
						...
						<li><i class="fas fa-check-circle"></i> Tahun pendirian: 2019.</li>
					</ul>
