	...
	<div class="container">
		<div class="pyramid-history-intro">
			...
			<div class="pyramid-history-content">
				<div class="section-title"><span>Perjalanan Pyramid</span>
					<h3 class="title">
						<?php echo !empty($sejarah['judul']) ? htmlspecialchars($sejarah['judul'], ENT_QUOTES, 'UTF-8') : 'Sejarah Piramidsoft'; ?>
					</h3>
				</div>
				<div class="pyramid-rich-content ql-editor">
					<?php echo !empty($sejarah['konten']) ? $sejarah['konten'] : '<p>Data sejarah belum tersedia.</p>'; ?>
				</div>
			</div>
		</div>
	</div>
