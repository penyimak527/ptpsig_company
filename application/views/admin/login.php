...
<head>
	...
	<style>
		:root { --login-navy: #061a31; --login-blue: #0b407a; --login-border: #d5dee8; }
		* { box-sizing: border-box; }
		...
		.login-brand img { display: block; width: 178px; height: 58px; object-fit: contain; }
		.login-content { padding: 0; }
		.login-content h1 { margin: 0 0 9px; font-size: 24px; font-weight: 700; color: var(--login-navy); text-align: center; }
		.login-content > p { max-width: 320px; margin: 0 auto 28px; font-size: 14px; line-height: 1.6; color: #6e7d8d; text-align: center; }
		...
		.login-label { position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0, 0, 0, 0); white-space: nowrap; border: 0; }
		...
		.login-footer { display: flex; justify-content: center; padding-top: 20px; margin-top: 24px; border-top: 1px solid #e6ebf0; }
		...
		@media (max-width: 575.98px) {
			...
			.login-brand img { width: 158px; height: 52px; }
			.login-content h1 { font-size: 22px; }
		}
	</style>
</head>
<body>
	<main class="login-page">
		<section class="login-panel" aria-labelledby="login-title">
			<div class="login-brand">
				<img src="<?php echo base_url('assets/img_pyramid/logo/LOGO PYRAMID BARU.png'); ?>" alt="Pyramidsoft">
			</div>
			<div class="login-content">
				<h1 id="login-title">Log in ke akun admin</h1>
